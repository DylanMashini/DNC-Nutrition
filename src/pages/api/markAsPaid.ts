        ...
        fetch(`${process.env.CLOVER_URL_SCL}v1/orders/${orderID}/pay`, {
            ...
            `,
                ...
                <li>
                    <div
                        ...
                        <div style="text-align:center;">
                            <img src="https://www.dncnutrition.com/products/${item.sku
                            }.jpeg" width="200px">
                        </div>
                        <div style="text-align:center;">
                ...
                `);
                    ...
                    <br />
                    <p>Customer Phone Number: ${session["customer_details"]["phone"]
                            }</p>
                    <p>Customer Email: ${session["customer_details"]["email"]
                            }</p>
                    <p>Customer Name: ${session["customer_details"]["name"]}</p>
                    <p>Customer Address Line 1: ${session["customer_details"]["address"]["line1"]
                            }</p>
                    ${session["customer_details"]["address"]["line2"]
                                ? `<p>Customer Address Line 2: ${session["customer_details"]["address"]["line2"]}</p>`
                                : ""
                            }
                    <p>Customer City: ${session["customer_details"]["address"]["city"]
                            }</p>
                    <p>Customer State: ${session["customer_details"]["address"]["state"]
                            }</p>
                    <p>Customer Zip: ${session["customer_details"]["address"]["postal_code"]
                            }</p>
            ...
            `,
                    ...
                    sgMail
                        .send(msg)
                        .then(async () => {
                            // Send Confrimation Email to Customer
                            const confMsg = {
                                to: session["customer_details"]["email"],
                                from: "ecommerce@dylanmashini.com",
                                subject: "DNC Nutrition Order Confirmation",
                                text: "Order Confirmation from DNC Nutrition",
                                html: `
                                <div>
                                    <h1 style="margin-bottom: 1.25em;">Thanks for your purchase!</h1>
                                    <h4 style="">Your Order Will ship in 1-3 buisness days. If you have any questions, or need assistance, feel free to reach out to us! You can email us directly at <a href="mailto:discountnutritionatl@gmail.com">discountnutritionatl@gmail.com</a> or give us a call at <a href="tel:4042282712">+1 (404) 228 2712</a></h4>
                                    <h3>Order Summary</h3> 
                                    ${emailItems}                                    
                                </div>
                                `
                            }
                            await sgMail.send(confMsg)
                            // save to mongodb
                            saveToMongoDB(
                                orderID,
                                msg.html,
