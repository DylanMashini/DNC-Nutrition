...
export default async function updateUser(
	...
	try {
		...
		if (user && (!newUser || userEmail == email)) {
			//make sure that user exists and that if they are attemting to change their email that one doesn't already exist with that email
