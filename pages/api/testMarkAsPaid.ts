...
export default async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    const stripe = require('stripe')("sk_test_51CqrmSFdiICzWvf0mXCNWcXApx6KQ8WGmrPLDDS9LqMmYnmIX7WC7BrQaIfCcHz09ZBheBiQo1b0PJ6Eg2x24TZV00w5rqWKNt");
    const endpointSecret = "whsec_T50WuGhbbq2eCawweksnwwQwT2v3TEzi"
